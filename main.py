...
def how_to_play():
    ...
    print("To fight an enemy, move your character to the enemy symbol and you will automatically be placed in a fight situation.")
    print("In a fight you can attack, use an item, or flee. The fight ends when either you or the enemy is defeated, or when you successfully flee.")
